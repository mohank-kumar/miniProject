...
const {registerSchema, loginSchema, confirmSchema, emailSchema, verifyOtpSchema, resetPasswordSchema, changePasswordSchema, updateUserSchema} = require("../utils/validator.utils");
...
router.post("/resendVerification",  validationMiddleware(emailSchema), Controller.resendVerification);
